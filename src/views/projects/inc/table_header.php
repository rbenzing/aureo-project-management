...
<div class="flex flex-wrap items-center gap-4">
    <form action="/projects" method="GET" class="flex-grow sm:flex-grow-0 flex gap-4">
        ...
        <button type="submit" class="px-4 py-2 bg-gray-700 text-white border border-gray-600 rounded-md hover:bg-gray-600">
            Search
        </button>
        
        <?php if (isset($_GET['search']) || isset($_GET['status']) || isset($_GET['company_id'])): ?>
            <a href="/projects?view=table" class="px-4 py-2 bg-gray-700 text-white border border-gray-600 rounded-md hover:bg-gray-600">
                Clear Filters
            </a>
        <?php endif; ?>
    </form>
    ...
    <div class="dropdown relative">
        <button class="px-4 py-2 text-white border border-gray-600 rounded-md hover:bg-gray-700">
            ☑ Filter
        </button>
        <div class="dropdown-menu hidden absolute right-0 mt-2 w-56 bg-gray-800 border border-gray-700 rounded-md shadow-lg z-10">
            <form action="/projects" method="GET" class="p-4">
                ...
                <div class="mb-3">
                    ...
                    <select name="status" class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md">
                ...
                <div class="mb-3">
                    ...
                    <select name="company_id" class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md">
