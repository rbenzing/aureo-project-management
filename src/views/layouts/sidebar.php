<aside class="bg-gray-800 text-white w-64 min-h-screen fixed top-0 left-0 z-10 transition-transform duration-300 ease-in-out transform -translate-x-full md:translate-x-0" id="sidebar">
    <div class="p-4">
        ...
        <ul class="space-y-2">
            ...
            <li><a href="/projects" class="block hover:bg-gray-700 p-2 rounded">Projects</a></li>
            <li><a href="/tasks" class="block hover:bg-gray-700 p-2 rounded">Tasks</a></li>
            <li><a href="/users" class="block hover:bg-gray-700 p-2 rounded">Users</a></li>
        </ul>
    </div>
</aside>
