<?php
// file: Views/Milestones/inc/project_header.php
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow mb-6 overflow-hidden">
    <div class="p-4 md:p-6 flex flex-col md:flex-row md:items-center md:justify-between">
        ...
        <div class="flex space-x-2">
            ...
            <a href="/milestones/create?project_id=<?= $project->id ?? 0 ?>" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">
                + New Milestone
            </a>
        </div>
    </div>
    ...
    <div class="border-t border-gray-200 dark:border-gray-700 px-4">
        <div class="flex overflow-x-auto">
            ...
            <a href="/milestones/project/<?= $project->id ?? 0 ?>" class="px-4 py-3 text-sm font-medium border-b-2 border-indigo-500 text-indigo-600 dark:text-indigo-400 whitespace-nowrap">
                Milestones
            </a>
        </div>
    </div>
