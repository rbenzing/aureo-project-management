...
<div class="flex justify-between items-center mb-6">
    ...
    <div class="flex space-x-4">
        ...
        <div class="relative min-w-[160px]">
            <select id="milestone-filter" class="h-10 appearance-none w-full px-4 py-2 dark:text-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md pl-10 pr-10 focus:outline-none focus:ring-2 focus:ring-indigo-500">
        ...
        <div class="relative min-w-[200px]">
            <select id="project-filter" class="h-10 appearance-none w-full px-4 py-2 dark:text-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md pl-10 pr-10 focus:outline-none focus:ring-2 focus:ring-indigo-500">
