...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen flex flex-col">
    ...
    <main class="flex-grow md:ml-64 p-6">
        ...
        <?php if (!empty($tasks)): ?>
            <ul class="space-y-2">
                <?php foreach ($tasks as $task): ?>
                    <li>
                        <a href="/tasks/view.php?id=<?php echo $task->id; ?>" class="text-indigo-600 hover:text-indigo-900">
        ...
        <!-- Create Button -->
        <a href="/tasks/create.php" class="mt-4 inline-block px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700">Create New Task</a>
    </main>
